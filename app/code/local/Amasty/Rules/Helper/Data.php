...
class Amasty_Rules_Helper_Data extends Mage_Core_Helper_Abstract
{
  ...
  //  const WHOLE_CART                = 'whole_cart';
    ...
    public function getNoneMaxDiscountRules() {
        return array('money_amount', 'buy_x_get_y_fixdisc', 'buy_x_get_y_fixed', 'buy_x_get_n_fixdisc',
            'buy_x_get_n_fixed', 'each_n_fixdisc', 'fixed', 'each_m_aft_n_disc', 'each_m_aft_n_fix', 'group_n', 'after_n_fixdisc',
