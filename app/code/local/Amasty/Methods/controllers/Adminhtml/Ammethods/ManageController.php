...
class Amasty_Methods_Adminhtml_Ammethods_ManageController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        $restrictMethod = $this->getRequest()->getPost('restrict_method');
        ...
        Mage::getConfig()->saveConfig('ammethods/'. $type . '/' . Amasty_Methods_Helper_Data::VAR_RESTRICT_METHOD, $restrictMethod);
